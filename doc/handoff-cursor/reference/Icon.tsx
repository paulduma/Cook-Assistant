// reference/Icon.tsx
// Jeu d'icônes au trait, cohérent avec la direction éditoriale.
// Stroke fin, currentColor, pas de remplissage. Réutilisable partout.
//
// Si vous utilisez déjà lucide-react, vous pouvez remplacer ce fichier par les
// imports équivalents (voir 01-design-system.md §7) — gardez le stroke fin.
